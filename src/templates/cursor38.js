...
const cursorCSS = {
    ...
    .cjs-38-trail-span.cjs-normal {
        transition: transform 0.2s ease;
    }

    .cjs-38-trail-span.cjs-delay {
...
class cursor extends Template {
    ...
    animateTrail() {
        ...
        if (!this.isAnimating) {
            ...
            this.trailElements.forEach((trailElement, index) => {
                ...
                const scalVal = ((this.trailElements.length - index) / this.trailElements.length);
    ...
    createTrailElements(delay) {
        this.trailContainer = curs_Span1({zIndex: this.zIndex, classes: 'cjs-38'})

        for (let i = 0; i < 10; i++) {
            // let trailSpan = curs_SpanNoDelay({color: this.color, classes: 'cjs-span cjs-38-trail-span', parent: this.trailContainer});
            let trailSpan = curs_Span1({color: this.color, zIndex: this.zIndex, classes: 'cjs-span cjs-38-trail-span', parent: this.trailContainer, delay: delay})

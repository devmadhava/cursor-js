...
export class cursor extends Template {
    ...
    create({color, zIndex, delay}) {
        ...
        this.cursor1 = curs_SpanNoDelay({zIndex, color: color1 || '#000', classes: 'cjs-span cjs-42-1'});
        this.cursor2 = curs_SpanNoDelay({zIndex, color: color2 || '#000', classes: 'cjs-span cjs-42-2'});

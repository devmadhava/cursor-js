...
const cursorCSS = {
    ...
    .cjs-20-para {
        ...
        animation: cjs-20-para-rotate-anim 10s linear infinite;
    }
    ...
    .cjs-20.button > .cjs-20-span {
        transform: scale(0.5);
    }

    .cjs-20.image > .cjs-20-span {
        transform: scale(0.5);
    }

    .cjs-20.click > .cjs-20-span {
        transform: scale(0.2);

    }

    @keyframes cjs-20-para-rotate-anim {
        0% {
...
export class cursor extends Template {
    ...
    create({color, textColor, zIndex, text, imageText, delay}) {
        ...
        this.cursor1 = curs_SpanTextWithDelay({zIndex, color: 'transparent', textColor: textColor, font: "Monospace", classes: "cjs-span cjs-20", delay});

        const textElement = document.createElement('p');
        textElement.classList.add('cjs-20-para')
        textElement.innerText = text;
        this.cursor1.appendChild(textElement);
        curs_circularText({size: 100, element: textElement, spacing: 14});

        const spanElement = document.createElement('span');
        spanElement.classList.add('cjs-20-span');

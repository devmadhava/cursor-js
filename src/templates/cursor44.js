...
export class cursor extends Template {
    ...
    create({color, zIndex}) {
        ...
        this.cursor1 = curs_SpanNoDelay({zIndex, color: color1 || '#000', classes: 'cjs-span cjs-44-1'});
        this.cursor2 = curs_SpanNoDelay({zIndex, color: color2 || '#000', classes: 'cjs-span cjs-44-2'});

...
const cursorCSS = {
    ...
    .cjs-19-1 {
        ...
        animation: cjs-19-1-para-rotate-anim 10s linear infinite;
    }
    ...
    @keyframes cjs-19-1-para-rotate-anim {
        0% {
...
export const cursor = {
    ...
    create: function ({color, textColor, zIndex, text, imageText}) {
        ...
        this.cursor1 = curs_SpanTextNoDelay({zIndex, color: 'transparent', textColor: textColor, font: "Monospace", classes: "cjs-span cjs-19-1"});
        this.cursor2 = curs_SpanNoDelay({zIndex, color: color, classes: 'cjs-span cjs-19-2'});


        const textElement = document.createElement('p');
        textElement.classList.add('cjs-19-1-para')

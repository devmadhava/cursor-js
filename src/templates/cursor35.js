...
const cursorCSS = {
    ...
    .cjs-35-trail-span.cjs-normal {
        transition: transform 0.2s ease;
    }

    .cjs-35-trail-span.cjs-delay {
...
class cursor extends Template {
    ...
    createTrailElements(delay) {
        this.trailContainer = curs_Span1({zIndex: this.zIndex, classes: 'cjs-35'})

        for (let i = 0; i < 10; i++) {
            // let trailSpan = curs_SpanNoDelay({color: this.color, classes: 'cjs-span cjs-35-trail-span', parent: this.trailContainer});
            let trailSpan = curs_Span1({color: this.color, zIndex: this.zIndex, classes: 'cjs-span cjs-35-trail-span', parent: this.trailContainer, delay: delay})
